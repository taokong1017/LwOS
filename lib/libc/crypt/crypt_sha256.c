...
static char *sha256crypt(const char *key, const char *setting, char *output) {
	...
	const unsigned char perm[][3] = {
		{0, 10, 20}, {21, 1, 11}, {12, 22, 2}, {3, 13, 23}, {24, 4, 14},
		{15, 25, 5}, {6, 16, 26}, {27, 7, 17}, {18, 28, 8}, {9, 19, 29}};
	for (i = 0; i < 10; i++)
		p = to64(
			p, (md[perm[i][0]] << 16) | (md[perm[i][1]] << 8) | md[perm[i][2]],
			4);
...
char *__crypt_sha256(const char *key, const char *setting, char *output) {
	const char testkey[] = "Xy01@#\x01\x02\x80\x7f\xff\r\n\x81\t !";
	const char testsetting[] = "$5$rounds=1234$abc0123456789$";
	const char testhash[] =
		"$5$rounds=1234$abc0123456789$3VfDjPt05VHFn47C/ojFZ6KRPYrOjj1lLbH.dkF3bZ6";
	char testbuf[128];
	char *p, *q;
